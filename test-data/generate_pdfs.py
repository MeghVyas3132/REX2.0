...
"""Generate test PDF files for REX2.0 knowledge corpus ingestion testing.""""""Generate test PDF files for REX2.0 knowledge corpus ingestion testing."""



from fpdf import FPDFfrom fpdf import FPDF
...
def create_pdf(filename: str, title: str, sections: list[tuple[str, str]]):def create_pdf(filename: str, title: str, sections: list[tuple[str, str]]):

    """Create a PDF with a title and multiple sections."""    """Create a PDF with a title and multiple sections."""
    ...
    pdf.set_font("Helvetica", "B", 20)    pdf.set_font("Helvetica", "B", 20)

    pdf.cell(0, 15, title, new_x="LMARGIN", new_y="NEXT", align="C")    pdf.cell(0, 15, title, new_x="LMARGIN", new_y="NEXT", align="C")
    ...
    for heading, body in sections:    for heading, body in sections:
        ...
        pdf.cell(0, 10, heading, new_x="LMARGIN", new_y="NEXT")        pdf.cell(0, 10, heading, new_x="LMARGIN", new_y="NEXT")
        ...
        pdf.set_font("Helvetica", "", 11)        pdf.set_font("Helvetica", "", 11)

        pdf.multi_cell(0, 6, body)        pdf.multi_cell(0, 6, body)
    ...
    pdf.output(path)    pdf.output(path)

    print(f"  Created: {path}")    print(f"  Created: {path}")





# ── PDF 1: Machine Learning Fundamentals ─────────────────────────────────────# ── PDF 1: Machine Learning Fundamentals ─────────────────────────────────────

create_pdf(create_pdf(

    "machine_learning_fundamentals.pdf",    "machine_learning_fundamentals.pdf",
    ...
    [    [
        ...
        (        (
            ...
            "Machine learning is a subset of artificial intelligence that enables systems to learn and improve from experience without being explicitly programmed. It focuses on developing algorithms that can access data and use it to learn for themselves. The process begins with observations or data, such as examples, direct experience, or instruction, to look for patterns in data and make better decisions in the future based on the examples provided.",            "Machine learning is a subset of artificial intelligence that enables systems to learn and improve from experience without being explicitly programmed. It focuses on developing algorithms that can access data and use it to learn for themselves. The process begins with observations or data, such as examples, direct experience, or instruction, to look for patterns in data and make better decisions in the future based on the examples provided.",
        ...
        (        (
            ...
            "Reinforcement Learning: The algorithm learns by interacting with an environment, receiving rewards or penalties for actions taken. It is used in robotics, game playing, and autonomous vehicles.",            "Reinforcement Learning: The algorithm learns by interacting with an environment, receiving rewards or penalties for actions taken. It is used in robotics, game playing, and autonomous vehicles.",
        ...
        (        (
            ...
            "Mean Squared Error (MSE): Used for regression tasks, measuring average squared differences between predicted and actual values.",            "Mean Squared Error (MSE): Used for regression tasks, measuring average squared differences between predicted and actual values.",
...
# ── PDF 2: Natural Language Processing ────────────────────────────────────────# ── PDF 2: Natural Language Processing ────────────────────────────────────────

create_pdf(create_pdf(

    "natural_language_processing.pdf",    "natural_language_processing.pdf",

    "Natural Language Processing: A Comprehensive Guide",    "Natural Language Processing: A Comprehensive Guide",
    ...
    [    [
        ...
        (        (
            ...
            "Named Entity Recognition (NER): Identifying entities like persons, organizations, and locations in text.",            "Named Entity Recognition (NER): Identifying entities like persons, organizations, and locations in text.",
        ...
        (        (
            ...
            "These embeddings enable mathematical operations on words, such as king - man + woman = queen.",            "These embeddings enable mathematical operations on words, such as king - man + woman = queen.",
        ...
        (        (
            ...
            "Transformers are the foundation for models like BERT, GPT, T5, and LLaMA.",            "Transformers are the foundation for models like BERT, GPT, T5, and LLaMA.",
        ...
        (        (
            ...
            "RAG reduces hallucination, provides up-to-date information, and allows domain-specific knowledge injection without fine-tuning. Popular vector databases include Pinecone, Weaviate, Chroma, and pgvector (PostgreSQL extension).",            "RAG reduces hallucination, provides up-to-date information, and allows domain-specific knowledge injection without fine-tuning. Popular vector databases include Pinecone, Weaviate, Chroma, and pgvector (PostgreSQL extension).",
...
# ── PDF 3: Cloud Architecture Best Practices ─────────────────────────────────# ── PDF 3: Cloud Architecture Best Practices ─────────────────────────────────

create_pdf(create_pdf(

    "cloud_architecture_best_practices.pdf",    "cloud_architecture_best_practices.pdf",
    ...
    [    [
        ...
        (        (
            ...
            "1. Cloud Computing Models",            "1. Cloud Computing Models",
            ...
            "Software as a Service (SaaS): Delivers software applications over the internet on a subscription basis. Examples include Salesforce, Google Workspace, and Microsoft 365.",            "Software as a Service (SaaS): Delivers software applications over the internet on a subscription basis. Examples include Salesforce, Google Workspace, and Microsoft 365.",
        ...
        (        (
            ...
            "Container orchestration handles scheduling, scaling, networking, and health management of containers across clusters.",            "Container orchestration handles scheduling, scaling, networking, and health management of containers across clusters.",
        ...
        (        (
            ...
            "Zero Trust Architecture: Verify every request regardless of network location.",            "Zero Trust Architecture: Verify every request regardless of network location.",
        ...
        (        (
            ...
            "Service Level Objectives (SLOs) define reliability targets, while Service Level Indicators (SLIs) measure actual performance against those targets.",            "Service Level Objectives (SLOs) define reliability targets, while Service Level Indicators (SLIs) measure actual performance against those targets.",
...
# ── PDF 4: Data Engineering Pipeline Design ───────────────────────────────────# ── PDF 4: Data Engineering Pipeline Design ───────────────────────────────────

create_pdf(create_pdf(

    "data_engineering_pipelines.pdf",    "data_engineering_pipelines.pdf",
    ...
    [    [
        ...
        (        (
            ...
            "Modern data stacks increasingly favor ELT due to the scalability of cloud warehouses and the flexibility of transforming data in place.",            "Modern data stacks increasingly favor ELT due to the scalability of cloud warehouses and the flexibility of transforming data in place.",
        ...
        (        (
            ...
            "Key concepts include windowing (tumbling, sliding, session windows), watermarks for handling late data, and state management for aggregations.",            "Key concepts include windowing (tumbling, sliding, session windows), watermarks for handling late data, and state management for aggregations.",

        ),        ),

        (        (

            "3. Data Quality and Governance",            "3. Data Quality and Governance",
            ...
            "dbt (data build tool): Transform data in-warehouse with built-in testing and documentation.",            "dbt (data build tool): Transform data in-warehouse with built-in testing and documentation.",

        ),        ),

        (        (

            "4. Orchestration Frameworks",            "4. Orchestration Frameworks",
            ...
            "DAG-based orchestration is particularly effective for workflows with complex dependencies, retry logic, and scheduling requirements. Each node in the DAG represents a task, and edges represent dependencies between tasks.",            "DAG-based orchestration is particularly effective for workflows with complex dependencies, retry logic, and scheduling requirements. Each node in the DAG represents a task, and edges represent dependencies between tasks.",
        ...
        (        (
            ...
            "Vector search uses algorithms like HNSW (Hierarchical Navigable Small World) and IVF (Inverted File Index) for approximate nearest neighbor search. These databases are essential for RAG systems, recommendation engines, and semantic search applications.",            "Vector search uses algorithms like HNSW (Hierarchical Navigable Small World) and IVF (Inverted File Index) for approximate nearest neighbor search. These databases are essential for RAG systems, recommendation engines, and semantic search applications.",
...
# ── PDF 5: API Design and REST Best Practices ────────────────────────────────# ── PDF 5: API Design and REST Best Practices ────────────────────────────────

create_pdf(create_pdf(

    "api_design_best_practices.pdf",    "api_design_best_practices.pdf",
    ...
    [    [
        ...
        (        (
            ...
            "1. RESTful API Principles",            "1. RESTful API Principles",
            ...
            "Example: GET /api/v1/workflows returns a list of workflows. POST /api/v1/workflows creates a new workflow. GET /api/v1/workflows/:id returns a specific workflow.",            "Example: GET /api/v1/workflows returns a list of workflows. POST /api/v1/workflows creates a new workflow. GET /api/v1/workflows/:id returns a specific workflow.",
        ...
        (        (
            ...
            "ABAC (Attribute-Based Access Control): Fine-grained access based on user, resource, and environment attributes.",            "ABAC (Attribute-Based Access Control): Fine-grained access based on user, resource, and environment attributes.",

        ),        ),

        (        (

            "3. Rate Limiting and Throttling",            "3. Rate Limiting and Throttling",
            ...
            "Implementation typically uses Redis for distributed rate limiting. Response headers should include X-RateLimit-Limit, X-RateLimit-Remaining, and X-RateLimit-Reset. Return HTTP 429 (Too Many Requests) when limits are exceeded.",            "Implementation typically uses Redis for distributed rate limiting. Response headers should include X-RateLimit-Limit, X-RateLimit-Remaining, and X-RateLimit-Reset. Return HTTP 429 (Too Many Requests) when limits are exceeded.",
        ...
        (        (
            ...
            "Best practices include maintaining at least two active versions, providing clear deprecation timelines, using semantic versioning for breaking changes, and documenting migration guides between versions.",            "Best practices include maintaining at least two active versions, providing clear deprecation timelines, using semantic versioning for breaking changes, and documenting migration guides between versions.",
        ...
        (        (
            ...
            "Example: { \"error\": { \"code\": \"VALIDATION_ERROR\", \"message\": \"Invalid workflow configuration\", \"details\": [{ \"field\": \"nodes\", \"message\": \"At least one node is required\" }], \"requestId\": \"req_abc123\" } }",            "Example: { \"error\": { \"code\": \"VALIDATION_ERROR\", \"message\": \"Invalid workflow configuration\", \"details\": [{ \"field\": \"nodes\", \"message\": \"At least one node is required\" }], \"requestId\": \"req_abc123\" } }",
...
print(f"\nAll 5 PDFs created in: {OUTPUT_DIR}")print(f"\nAll PDFs created in: {OUTPUT_DIR}")

print("Files ready for knowledge corpus ingestion via the REX UI.")print("Files ready for knowledge corpus ingestion via the REX UI.")
